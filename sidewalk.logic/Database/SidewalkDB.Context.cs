...
namespace Sidewalk.Logic.Database
{
    ...
    public partial class SWPostEntities : DbContext
    {
        ...
        public virtual DbSet<PORT_TAXLOTS_PDX> PORT_TAXLOTS_PDX { get; set; }
        ...
        public virtual DbSet<TrackIT> TrackIT { get; set; }
        ...
        public virtual ObjectResult<sp_getAffidavitByProperty_swp_Result> sp_getAffidavitByProperty_swp(string keyword)
        {
            var keywordParameter = keyword != null ?
                new ObjectParameter("keyword", keyword) :
                new ObjectParameter("keyword", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getAffidavitByProperty_swp_Result>("sp_getAffidavitByProperty_swp", keywordParameter);
        }
    
        public virtual ObjectResult<sp_getAffidavitList_swp_Result> sp_getAffidavitList_swp()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getAffidavitList_swp_Result>("sp_getAffidavitList_swp");
        }
    
        public virtual ObjectResult<sp_getAffidavitDetails_swp_Result> sp_getAffidavitDetails_swp(string affidavitId)
        {
            var affidavitIdParameter = affidavitId != null ?
                new ObjectParameter("affidavitId", affidavitId) :
                new ObjectParameter("affidavitId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getAffidavitDetails_swp_Result>("sp_getAffidavitDetails_swp", affidavitIdParameter);
        }
    
        public virtual ObjectResult<sp_getAffidavitByParameter_swp_Result> sp_getAffidavitByParameter_swp(string affidavitId, string propertyId, string inspectionDate, string postingDate, string trackId, string inspectorName, string propertyAddress, string previouslyPrinted, string fromDate, string todate)
        {
            var affidavitIdParameter = affidavitId != null ?
                new ObjectParameter("affidavitId", affidavitId) :
                new ObjectParameter("affidavitId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_getAffidavitByParameter_swp_Result>("sp_getAffidavitByParameter_swp", affidavitIdParameter, propertyIdParameter, inspectionDateParameter, postingDateParameter, trackIdParameter, inspectorNameParameter, propertyAddressParameter, previouslyPrintedParameter, fromDateParameter, todateParameter);
        }
    }
}
